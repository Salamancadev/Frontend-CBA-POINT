<template>
  <div class="bg-gradient-to-br from-gray-100 via-gray-50 to-white min-h-screen p-6 text-gray-800 font-sans">
    <!-- Header -->
    <header class="mb-10">
      ...
      <p class="text-lg text-gray-600">
        Bienvenido, <span class="font-semibold">{{ mappedUser.nombre }} {{ mappedUser.apellido }}</span>
      </p>
    </header>

    <!-- Stats Grid -->
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
      <div class="bg-white rounded-2xl p-6 flex items-center shadow-lg hover:-translate-y-1 hover:shadow-xl transition">
        <div class="h-12 w-12 flex items-center justify-center rounded-full bg-green-100 text-green-600 text-2xl mr-4">👥</div>
        <div>
      ...
      <div class="bg-white rounded-2xl p-6 flex items-center shadow-lg hover:-translate-y-1 hover:shadow-xl transition">
        <div class="h-12 w-12 flex items-center justify-center rounded-full bg-purple-100 text-purple-600 text-2xl mr-4">📅</div>
        <div>
      ...
      <div class="bg-white rounded-2xl p-6 flex items-center shadow-lg hover:-translate-y-1 hover:shadow-xl transition">
        <div class="h-12 w-12 flex items-center justify-center rounded-full bg-blue-100 text-blue-600 text-2xl mr-4">✅</div>
        <div>
      ...
      <div class="bg-white rounded-2xl p-6 flex items-center shadow-lg hover:-translate-y-1 hover:shadow-xl transition">
        <div class="h-12 w-12 flex items-center justify-center rounded-full bg-yellow-100 text-yellow-600 text-2xl mr-4">📊</div>
        <div>
    ...
    <section>
      ...
      <div class="bg-white rounded-2xl shadow divide-y">
        ...
        >
          <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-gray-100 text-xl mr-4">
            {{ activity.icon }}
          </div>
          <div class="flex-1">
