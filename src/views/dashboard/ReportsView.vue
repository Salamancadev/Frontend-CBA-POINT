  ...
  >
    <div class="text-center mb-8">
      ...
      <p class="text-lg mb-4" style="color: #7ed957">
        Análisis de asistencia y participación académica
      </p>
    </div>

    <div class="mb-10">
      <div
        class="grid grid-cols-1 md:grid-cols-3 gap-6 bg-[#212529] border-2 border-[#7ED957] rounded-2xl p-6 shadow-xl"
      >
        <div class="flex flex-col gap-2">
          <label class="font-semibold text-[#7ED957]">Período:</label>
          <select
            v-model="filters.period"
            class="rounded-lg px-4 py-2 bg-[#212529] border-2 border-[#7ED957] text-[#7ED957] focus:outline-none"
          >
        ...
        <button
          ...
          class="px-6 py-3 rounded-lg font-bold shadow-lg hover:scale-105 transition"
    ...
    <div class="mb-10">
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <div
          class="rounded-2xl p-6 flex items-center shadow-lg hover:-translate-y-1 hover:shadow-xl transition-transform duration-200"
          style="background-color: #212529; border: 2px solid #7ed957"
        >
          <div class="text-3xl mr-4" style="color: #7ed957">👥</div>
          <div>
            <h3 class="text-3xl font-extrabold" style="color: #7ed957">
    ...
    <div class="mb-10">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div
          ...
          style="background-color: #212529; border: 2px solid #7ed957"
        >
          <h3 class="text-xl font-bold mb-4 text-center" style="color: #7ed957">
            Asistencia por Día
          </h3>
        ...
        >
          ...
          <div class="flex flex-col gap-4 items-center">
            <div
              v-for="(item, index) in attendanceByType"
              :key="index"
          ...
          <table class="min-w-full text-sm">
            ...
            <tbody>
              <tr
                ...
                :key="record.id"
                class="border-b border-[#7ED957] hover:bg-[#263238]"
              >
                  ...
                  <span
                    ...
                    :style="
                      record.tipo === 'clase'
                        ...
                        : record.tipo === 'evento'
                          ? 'background-color: #ffb300; color: #212529;'
                    ...
                    :style="
                      record.estado === 'presente'
                        ...
                        : record.estado === 'ausente'
                          ...
                          : 'background-color: #ffb300; color: #212529;'
                    "
                    >{{ getStatusText(record.estado) }}</span
                  >
                </td>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="rounded-xl p-6 shadow-lg" style="background-color: #263238">
            ...
            <div
              ...
              :style="trendData.isPositive ? 'color: #7ED957;' : 'color: #ff4d4f;'"
            >
              {{ trendData.isPositive ? '📈' : '📉' }} {{ trendData.percentage }}% vs período
              anterior
            </div>
          ...
          <div class="rounded-xl p-6 shadow-lg" style="background-color: #263238">
            ...
            <div class="flex flex-col gap-2">
              <div
                ...
                :key="student.id"
                class="flex justify-between items-center bg-[#212529] rounded-lg px-4 py-2"
              >
...
const totalPages = computed(() => Math.ceil(attendanceRecords.value.length / recordsPerPage))
